<template>
  <section class="pod-panel pod-sku-panel">
    ...
    <a-table class="pod-sku-table" row-key="key" :data="skuRows" :pagination="false" :scroll="skuTableScroll">
      <template #columns>
        <a-table-column data-index="specValueOne" :width="POD_SKU_COLUMN_WIDTHS.specValue" align="center">
          <template #title>
        ...
        <a-table-column data-index="specValueTwo" :width="POD_SKU_COLUMN_WIDTHS.specValue" align="center">
          <template #title>
        ...
        <a-table-column
          :width="POD_SKU_COLUMN_WIDTHS.previewImage"
          align="center"
        ...
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.price" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].declaredPrice" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.price" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].price" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.dimension" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].length" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.dimension" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].width" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.dimension" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].height" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.weight" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].weight" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.stock" align="center">
          <template #title>
            <span class="pod-table-title">&#x5E93;&#x5B58;<a-tooltip content="&#x8BE5; SKU &#x5E93;&#x5B58;&#x6570;&#x91CF;&#xFF0C;&#x6309;&#x884C;&#x5BFC;&#x51FA;&#x3002;"><icon-question-circle class="pod-help-icon" /></a-tooltip></span>
          </template>
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].stock" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.platformSku" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].platformSku" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.skuCategory" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].skuCategoryType" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.skuCategory" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].skuCategoryCount" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.skuCategory" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-input v-model="skuConfigMap[record.key].skuCategoryUnit" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
        <a-table-column :width="POD_SKU_COLUMN_WIDTHS.independentPackaging" align="center">
          <template #title>
          ...
          <template #cell="{ record }"><div class="pod-sku-cell-control"><a-select v-model="skuConfigMap[record.key].independentPackaging" allow-clear popup-container="body" :options="customOptions" @change="syncSkuConfigToProducts" /></div></template>
        </a-table-column>
      </template>
    </a-table>
  </section>
...
const previewImageHeaderCellStyle = Object.freeze({
  borderBottom: 'none'
});
